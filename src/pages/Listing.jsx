...
export default function Listing() {
  ...
  return (
    <main>
        ...
        <div className="fixed top-[15%] right-[3%] z-10 bg-white cursor-pointer
            border-gray-400 rounded-full w-12 h-12 flex justify-center items-center"
            onClick={()=>{
                navigator.clipboard.writeText(window.location.href); // copy functionality
        ...
        {shareLinkCopied && 
            <p className="fixed top-[20%] right-[5%] z-10 font-semibold border-2 text-sm
                border-gray-400 rounded-md bg-white p-2">
                    Link Copied
            </p>
        }
        <div className="m-4 p-4 rounded-lg flex flex-col md:flex-row max-w-6xl lg:mx-auto
        ...
        >
            <div className="w-full">
                ...
                <div className="flex justify-start items-center space-x-4 w-[75%]">
                    ...
                    {listing.offer && (
                        ...
                        text-center font-semibold shadow-md">${listing.regularPrice - listing.discountedPrice} discount</p>
                    )}
                </div>
                ...
                {/* "?" operation is to prevent an error caused by loading page first before the auth data  */}
            ...
            {/* map */}
            <div className="bg-blue-300 w-full h-[200px] md:h-[400px] mt-6 z-10 overflow-x-hidden
                            md:mt-0 md:ml-2
            ">
            <MapContainer 
